...
class DoblicateScreen extends StatefulWidget {
  @override
  _DoblicateScreenState createState() => _DoblicateScreenState();
}

class _DoblicateScreenState extends State<DoblicateScreen> {
        ...
        children: [
          ...
          Builder(builder: (context) {
            if (_hasPermissions) {
              return Column(
                children: <Widget>[
                  Expanded(child: _buildDoblicateScreen()),
                ],
              );
            } else {
